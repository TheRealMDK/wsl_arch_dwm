...
static const Rule rules[] = {
	...
	{ NULL,		  "primary",		NULL,		SPTAG(0),		1,			 -1 },
	{ NULL,		  "secondary",		NULL,		SPTAG(1),		1,			 -1 },
	{ NULL,		  "yazi",		NULL,		SPTAG(2),		1,			 -1 },
	{ NULL,		  "btop",		NULL,		SPTAG(3),		1,			 -1 },
	{ NULL,		  "termusic",	NULL,		SPTAG(4),		1,			 -1 },
};
...
static const char *wallpapercmd[] = {"/bin/sh", "-c", "~/scripts/theme.sh", NULL};
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_grave,      spawn,          {.v = wallpapercmd } },
